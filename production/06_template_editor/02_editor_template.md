# 02 — Halaman Editor Template Sertifikat

> **Prasyarat:** Service template sudah dibuat (file `01_upload_dan_preview.md` sudah selesai).
> **File target:** `src/pages/admin/TemplateEditorPage.tsx`

---

## Tujuan

Mengimplementasikan halaman editor template sertifikat dengan:
- Preview visual template PDF di kanvas
- Drag-and-drop untuk posisi nama peserta
- Panel kontrol untuk font, ukuran, warna, format teks
- Pilihan posisi QR code (4 pojok)
- Upload/ganti template PDF
...
│                                   │  Panel Kontrol  │
│         Kanvas Preview            │                 │
│   (PDF + overlay nama + QR)       │  - Font         │
│                                   │  - Ukuran       │
│   ← Nama bisa di-drag →          │  - Warna        │
│                                   │  - Format       │
│                                   │  - Posisi QR    │
│                                   │                 │
│                                   │  [Simpan]       │
...
- Desktop: 2 kolom (70% kanvas, 30% panel)
- Mobile: 1 kolom (kanvas atas, panel bawah), dengan input numerik X/Y sebagai alternatif drag

---

## Implementasi `src/pages/admin/TemplateEditorPage.tsx`
...
- **Preview di kanvas:** PDF dirender menjadi gambar menggunakan `pdfjs-dist`, kemudian elemen nama dan QR ditampilkan sebagai overlay yang bisa di-drag.
- **Posisi disimpan dalam persen** (0-100%) relatif terhadap dimensi template — sehingga konsisten di berbagai ukuran layar dan saat generate PDF final.
- **Panel kontrol sticky** di desktop — selalu terlihat tanpa scroll.
- **Mobile:** Input numerik X/Y sebagai alternatif drag.

---

## Kriteria Selesai

- [ ] Upload template PDF berfungsi dan tersimpan di Supabase Storage
- [ ] Preview template PDF ditampilkan di kanvas
- [ ] Nama peserta bisa di-drag di atas preview
- [ ] Panel kontrol: font, ukuran, warna, format berfungsi dan live-update
- [ ] Pilihan posisi QR code (4 pojok) berfungsi
- [ ] Tombol "Simpan Pengaturan" menyimpan ke database
- [ ] Tombol "Ganti Template" berfungsi dengan upload baru
- [ ] Layout responsive (2 kolom desktop, 1 kolom mobile)
- [ ] Input numerik X/Y sebagai alternatif drag tersedia
