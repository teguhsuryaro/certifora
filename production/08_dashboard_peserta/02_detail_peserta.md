# 02 — Detail Peserta & Preview Override

> **Prasyarat:** Tabel peserta sudah diimplementasi (file `01_tabel_peserta.md` sudah selesai).
> **File target:** `src/pages/admin/ParticipantDetailPage.tsx`

---

## Tujuan

Mengimplementasikan halaman detail peserta individual yang menampilkan:
- Info peserta lengkap
- Selfie ukuran penuh
- Preview sertifikat (simulasi visual)
- Override posisi nama dan ukuran font khusus peserta ini
- Tombol kirim/kirim ulang sertifikat
- Riwayat pengiriman

---

## Implementasi `src/pages/admin/ParticipantDetailPage.tsx`
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-2">
            <StatusBadge variant={deliveryBadge.variant}>{deliveryBadge.label}</StatusBadge>
        ...
        <div className="bg-white rounded-xl border border-neutral-200 p-6">
          ...
          <dl className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <dd><StatusBadge variant={deliveryBadge.variant}>{deliveryBadge.label}</StatusBadge></dd>
            </div>
          </dl>
...
- [ ] Detail peserta menampilkan nama, email, kode, selfie, status
- [ ] Selfie bisa dibuka dalam modal ukuran penuh
- [ ] Override posisi dan font size khusus peserta bisa disimpan
- [ ] Hint menampilkan nilai template utama sebagai referensi
- [ ] Riwayat pengiriman (delivery logs) ditampilkan
- [ ] Tombol kirim/kirim ulang tersedia (implementasi lengkap di folder 10)
- [ ] Breadcrumb navigasi kembali ke daftar peserta berfungsi
