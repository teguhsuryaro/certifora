# 01 — Landing Page Certifora

> **Prasyarat:** Export data sudah selesai (folder `12_export_data` selesai).
> **File target:** `src/pages/public/LandingPage.tsx`

---

## Tujuan

Mengimplementasikan landing page Certifora yang sederhana namun profesional. Halaman ini menjadi entry point utama website.

---

## Implementasi `src/pages/public/LandingPage.tsx`
...
- [ ] Landing page menampilkan hero section dengan tagline
- [ ] Badge "100% Gratis Selamanya" tampil
- [ ] Tombol CTA mengarah ke `/login`
- [ ] Section fitur (6 fitur) tampil dalam grid
- [ ] Section "Cara Kerja" (4 langkah) tampil
- [ ] Section CTA akhir dengan background warna primary
- [ ] Footer tampil
- [ ] Navbar sticky dengan backdrop blur
- [ ] Background decoration gradient tampil (efek visual)
- [ ] Layout responsive (mobile → tablet → desktop)
- [ ] Scroll ke `#features` dari tombol "Lihat Fitur"
